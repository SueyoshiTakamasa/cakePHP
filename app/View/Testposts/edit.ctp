<div class="testposts form">
    <ol class="breadcrumb">
        ...
        <li><?php echo $this->Html->link(__('Testpost'), array('action' => 'index'), array('escape' => false)); ?></li>
                <li class="active">『<?php echo h($this->request->data['Testpost']['name']); ?>』の<?php echo __('Edit'); ?></li>
            </ol>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered horizontal-form">
                                <?php echo $this->Form->hidden("Testpost.id", array('class' => 'form-control', 'label' => false, 'required' => false));?>
                                                                                                                                <tr>
